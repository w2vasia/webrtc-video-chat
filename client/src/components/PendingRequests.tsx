          ...
          {(req) => (
            <div class="flex justify-between items-center py-2 text-[0.9375rem]">
              ...
              <div class="flex gap-2">
                <button
                  class="flex items-center gap-1 px-3.5 py-1.5 bg-success hover:bg-success-hover text-white rounded-[10px] text-[0.8125rem] font-medium font-[inherit] cursor-pointer min-h-[32px] transition-colors"
                ...
                <button
                  class="flex items-center gap-1 px-3.5 py-1.5 bg-danger-soft hover:bg-red-100 text-danger rounded-[10px] text-[0.8125rem] font-medium font-[inherit] cursor-pointer min-h-[32px] transition-colors"
